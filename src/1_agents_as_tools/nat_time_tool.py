...
@register_function(
    config_type=TimeMCPToolConfig, framework_wrappers=[LLMFrameworkEnum.ADK]
)
async def get_city_time(
    _config: TimeMCPToolConfig, _builder: Builder
    ...
    yield FunctionInfo.from_fn(
        _get_city_time, description=_get_city_time.__doc__
    )

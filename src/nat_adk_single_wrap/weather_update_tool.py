...
class WeatherToolConfig(FunctionBaseConfig, name="weather_update_tool"):
    pass


@register_function(
    config_type=WeatherToolConfig, framework_wrappers=[LLMFrameworkEnum.ADK]
)
async def weather_update(
    _config: WeatherToolConfig, _builder: Builder
    ...
    yield FunctionInfo.from_fn(
        _weather_update, description=_weather_update.__doc__
    )
